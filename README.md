...
Это полнофункциональный GPS трекер, разработанный на ESP32-C3 с интуитивно понятным интерфейсом на OLED дисплее. Устройство способно записывать треки в высоком качестве, синхронизироваться с сервером через WiFi и управлять данными через удобное меню.
...
![Tracker Main](docs/images/tracker_gn.png)
